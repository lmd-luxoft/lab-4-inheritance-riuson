...
namespace Chess.Tests
{
    ...
    public class TestMovements
    {
        ...
        {
            var figure = new ChessFigure(FigureType.ROOK, "E2");
        ...
        {
            var figure = new ChessFigure(FigureType.KNIGHT, "B1");
        ...
        {
            var figure = new ChessFigure(FigureType.BISHOP, "C1");
        ...
        {
            var figure = new ChessFigure(FigureType.PAWN, "E2");
            Assert.AreEqual(true, figure.Move("E3"));
        }
        ...
        {
            var figure = new ChessFigure(FigureType.PAWN, "E4");
        ...
        {
            var figure = new ChessFigure(FigureType.KING, "E1");
        ...
        {
            var figure = new ChessFigure(FigureType.QUEEN, "D1");
