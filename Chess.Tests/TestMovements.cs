...
namespace Chess.Tests
{
    ...
    public class TestMovements
    {
        ...
        {
            var figure = new ChessFigure(ChessFigure.FigureType.ROOK, "E2");
        ...
        {
            var figure = new ChessFigure(ChessFigure.FigureType.KNIGHT, "B1");
        ...
        {
            var figure = new ChessFigure(ChessFigure.FigureType.BISHOP, "C1");
        ...
        {
            var figure = new ChessFigure(ChessFigure.FigureType.PAWN, "E2");
            Assert.AreEqual(true, figure.Move("E3"));
        }
        ...
        {
            var figure = new ChessFigure(ChessFigure.FigureType.PAWN, "E4");
